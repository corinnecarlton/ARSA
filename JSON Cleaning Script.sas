...
%let JSON_File_Path=P:\Case Documents\ZSmith\Corinne\survivor-ARSA1001.json;

/* Update name and path of cleaned data (MUST END WITH .CSV) */
%let Cleaned_Data_Path=P:\Case Documents\ZSmith\Corinne\Behavioral Data - survivor-ARSA1001.csv;

/* Update name and path of SAS log (MUST END WITH .LST) */
%let SAS_Log_Path=P:\Case Documents\ZSmith\Corinne\Behavioral Data - survivor-ARSA1001.lst;
